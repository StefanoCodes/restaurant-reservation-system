...
const { socialProof, title, description, primaryCta, secondaryCta } =
  ...
  return (
    <>
      <section className="relative w-full">
        ...
        {/* CONTENT */}
        <div className="relative mx-auto w-full px-5 sm:px-10 md:px-12 lg:max-w-7xl lg:px-5 lg:pt-8">
          <div
            aria-hidden="true"
          ...
          <div className="relative mx-auto grid max-w-2xl gap-10 pt-24 md:max-w-3xl lg:max-w-none lg:grid-cols-2 xl:gap-14">
            <div className="flex flex-col items-center lg:items-start lg:py-6">
              <div className="text-center lg:text-left">
                ...
                <h1 className="text-gradient text-clip pt-4 text-3xl font-bold leading-8 dark:text-white md:text-4xl lg:text-5xl">
                  {title}
                </h1>
              </div>
              <p className="mt-8 max-w-lg text-center text-gray-600 dark:text-gray-300 lg:text-left">
                {description}
              </p>
              ...
              <div className="mt-6 flex items-center gap-8 sm:flex-row">
                <div className="py-5">
