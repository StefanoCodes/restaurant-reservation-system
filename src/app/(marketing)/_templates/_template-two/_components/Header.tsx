          ...
          <div className="relative mx-auto grid max-w-2xl gap-10 pt-24 md:max-w-3xl lg:max-w-none lg:grid-cols-2 xl:gap-14">
            <div className="lg:py-6">
              <div className="text-center lg:text-left">
                ...
                <h1 className="pt-4 text-4xl font-bold leading-8 text-gray-800 dark:text-white md:text-5xl lg:text-6xl">
                  {title}
                </h1>
              </div>
              ...
              <div className="mx-auto flex w-max flex-col items-center gap-4 text-center sm:flex-row sm:gap-0 lg:mx-0">
